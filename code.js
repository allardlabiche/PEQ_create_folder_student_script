...
function genererDossiersEleves() {
  ...
  try {
    ...
    // =========================================================================
    const TEMPLATE_ID = 'ID_DU_FICHIER_DOSSIER_PEQ_TEMPLATE';
    const LISTING_ID = 'ID_DU_FICHIER_LISTING_ELEVES';
    const REPARTITION_ID = 'ID_DU_FICHIER_REPARTITION_ONGLETS';
    const CONFIG_CELLULE_ID = 'ID_DU_FICHIER_CONFIG_PEQ_CELLULE';
    const DOSSIER_DESTINATION_ID = 'ID_DU_DOSSIER_DRIVE_DE_RECEPTION'; 
    // =========================================================================
    ...
    for (let i = 1; i < listingData.length; i++) {
      ...
      let donneesEleve = {
        ...
        "Date Affichage Complet": listingData[i][9] // <-- Nouvelle ligne ajoutée ici
      };
